...
#read files
dfbo = pd.read_csv(DATA_PATH.joinpath("namur-budget-ordinaire-par-fonction-en.csv"), delimiter=";")
dfbe = pd.read_csv(DATA_PATH.joinpath("namur-budget-extraordinaire-par-fonction-en.csv"), delimiter=";")
...
col_fiscal_year = dfbo.columns[0]
#get distinct years
years = sorted(dfbo[col_fiscal_year].unique(), reverse=True)
